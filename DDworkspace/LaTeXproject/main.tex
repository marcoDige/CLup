...
\chapter{Architectural Design}\label{chapt:sum}
	...
	\section{Overview}
		...
		\input{sections/arch_design/overview.tex}

	\section{Component view}

		\input{sections/arch_design/comp_view.tex}

	\section{Deployment view}

		\input{sections/arch_design/depl_view.tex}

	\section{Runtime view}

		\input{sections/arch_design/runtime_view.tex}

	\section{Component interfaces}

		\input{sections/arch_design/comp_interf.tex}

	\section{Selected architectural styles and patterns}

		\input{sections/arch_design/patterns.tex}

	\section{Other design decisions}

		\input{sections/arch_design/other_design_decision.tex}

\chapter{User Interface Design}\label{chapt:sum}

		\input{sections/user_interface/user_interface.tex}

\chapter{Requirements Traceability}\label{chapt:sum}

	\input{sections/req_traceability/intro.tex}

	\input{sections/req_traceability/body.tex}

\chapter{Implementation, Integration and Test Plan}\label{chapt:sum}

	\input{sections/impl_int_test/intro.tex}

	\section{Implementation, Component Integration and Testing}
		
		\input{sections/impl_int_test/impl_comp_int.tex}

	\section{System Testing}

		\input{sections/impl_int_test/system_testing.tex}

	\section{Additional Specification on Testing}

		\input{sections/impl_int_test/add_spec_testing.tex}
